...
Esse foi um projeto da Trybe feito, onde foi utilizado conceitos de autenticação com a utilizacao do token jwt e arquitetura MSC, com conceitos de CRUD.

Para acessar o projeto, basta clonar o repositório e instalar as dependencias - npm install.
